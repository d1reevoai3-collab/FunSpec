...
public final class FogBlurPass {
   ...
   private final ShaderProgram program = ShaderProgram.fromResources(
      "assets/night/shaders/blur/blur_fullscreen.vert", "assets/night/shaders/postfx/fog_blur.frag"
   );
   private final ShaderProgram copyProgram = ShaderProgram.fromResources(
      "assets/night/shaders/blur/blur_fullscreen.vert", "assets/night/shaders/postfx/fog_copy.frag"
   );
