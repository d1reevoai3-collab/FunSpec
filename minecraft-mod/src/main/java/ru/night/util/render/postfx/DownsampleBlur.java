package ru.night.util.render.postfx;
...
import ru.night.util.render.backends.gl.GlState;
import ru.night.util.render.backends.gl.ShaderProgram;
...
public final class DownsampleBlur {
   ...
   public DownsampleBlur(int intermediateInternalFormat, int intermediatePixelType) {
      if (intermediateInternalFormat == 0) {
         ...
         this.downsampleProgram = ShaderProgram.fromResources(
            "assets/night/shaders/blur/blur_fullscreen.vert", "assets/night/shaders/blur/blur_downsample.frag"
         );
         this.upsampleProgram = ShaderProgram.fromResources("assets/night/shaders/blur/blur_fullscreen.vert", "assets/night/shaders/blur/blur_upsample.frag");
         this.smallHProgram = ShaderProgram.fromResources(
            "assets/night/shaders/blur/blur_fullscreen.vert", "assets/night/shaders/blur/blur_small_horizontal.frag"
         );
         this.smallVProgram = ShaderProgram.fromResources(
            "assets/night/shaders/blur/blur_fullscreen.vert", "assets/night/shaders/blur/blur_small_vertical.frag"
         );
   ...
   public void warmup() {
      if (this.downsampleProgram != null) this.downsampleProgram.use();
      if (this.upsampleProgram != null) this.upsampleProgram.use();
      if (this.smallHProgram != null) this.smallHProgram.use();
      if (this.smallVProgram != null) this.smallVProgram.use();
   }
