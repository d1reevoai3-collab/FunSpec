   ...
   public void ensure(int w, int h) {
      if (w > 0 && h > 0) {
         if (this.fbo == 0 || this.colorTex == 0 || this.depthTex == 0 || this.width != w || this.height != h) {
            ...
            GL11.glTexImage2D(3553, 0, 32856, this.width, this.height, 0, 6408, 5121, (java.nio.ByteBuffer) null);
            ...
            GL11.glTexImage2D(3553, 0, 33190, this.width, this.height, 0, 6402, 5125, (java.nio.ByteBuffer) null);
            GL11.glBindTexture(3553, 0);
