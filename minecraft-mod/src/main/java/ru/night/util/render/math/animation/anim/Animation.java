package ru.night.util.render.math.animation.anim;

import net.fabricmc.api.EnvType;
import net.fabricmc.api.Environment;
import ru.night.util.render.math.animation.anim.bezier.Bezier;
import ru.night.util.render.math.animation.anim.bezier.list.CubicBezier;
import ru.night.util.render.math.animation.anim.util.Easing;
