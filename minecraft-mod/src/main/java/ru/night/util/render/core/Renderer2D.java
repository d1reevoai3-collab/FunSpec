package ru.night.util.render.core;
...
import ru.night.util.render.text.FontObject;
import ru.night.util.render.text.TextRenderer;
   ...
   public static Vector2d project2D(double x, double y, double z) {
      ...
      if (camera == null) {
         ...
         if ((Boolean) mc.options.getBobView().getValue()
            ...
            float walkedDistance = playerEntity.strideDistance;
            float deltaDistance = walkedDistance - 0.0f; // Mocked lastStrideDistance
