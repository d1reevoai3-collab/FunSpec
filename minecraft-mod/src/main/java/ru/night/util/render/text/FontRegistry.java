package ru.night.util.render.text;
...
public final class FontRegistry {
   ...
   private static void registerBuiltinFonts() {
      INTER_MEDIUM = register("inter_medium", "assets/night/fonts/medium.json", "assets/night/fonts/medium.png");
      ICONS = register("icons", "assets/night/fonts/icons.json", "assets/night/fonts/icons.png");
      INTER_SEMIBOLD = register("inter_semibold", "assets/night/fonts/semibold.json", "assets/night/fonts/semibold.png");
   }
