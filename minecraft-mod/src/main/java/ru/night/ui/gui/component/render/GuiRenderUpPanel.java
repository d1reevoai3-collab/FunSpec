...
import ru.night.util.render.backends.gl.StencilHelper;
...
public class GuiRenderUpPanel extends GuiScreen {
   public static void renderUpPanel(Renderer2D renderer2D, MatrixStack pose, float mainAlpha) {
      ...
      renderer2D.text(FontRegistry.ICONS, GuiScreen.x + 9.92F, GuiScreen.y + 11.355F - 1.5F + 12.0F, 23.0F, "p", mainColor);
      renderer2D.text(FontRegistry.INTER_MEDIUM, GuiScreen.x + 28.17F, GuiScreen.y + 12.595F + 7.0F, 14.0F, "FunSpec", textColor);
      renderer2D.text(
         FontRegistry.INTER_MEDIUM,
         GuiScreen.x + 28.17F + renderer2D.measureText(FontRegistry.INTER_MEDIUM, "FunSpec", 14.0F).width + 3.0F,
         GuiScreen.y + 13.5F + 7.0F,
         10.0F,
         "1.0",
         textTwoColor40
