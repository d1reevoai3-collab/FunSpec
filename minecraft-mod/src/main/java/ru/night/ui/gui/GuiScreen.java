...
import ru.night.util.render.math.ScrollUtil;
import ru.night.util.render.math.animation.Animation;
import ru.night.util.render.math.animation.anim.util.Animation2;
import ru.night.util.render.math.animation.anim2.Easing;
...
public class GuiScreen {
   ...
   public static ru.night.util.render.math.animation.anim2.Animation alpha = new ru.night.util.render.math.animation.anim2.Animation(
      Easing.EASE_OUT_SINE, 1500L
   );
   public static ru.night.util.render.math.animation.anim.Animation animation = new ru.night.util.render.math.animation.anim.Animation();
   ...
   public static BooleanSetting clientBlurSetting = new BooleanSetting("Блюр нада?", false);
   public static boolean exit = false;
   public static long openTimestamp = 0L;
