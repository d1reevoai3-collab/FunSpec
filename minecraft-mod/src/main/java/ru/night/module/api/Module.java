...
import ru.night.module.api.setting.Config;
...
import ru.night.module.api.setting.impl.ListSetting;
...
import ru.night.util.render.math.animation.Translate;
...
import ru.night.util.render.math.animation.impl.EaseInOutQuad;
import ru.night.util.render.utils.SoundUtil;
...
public class Module extends Config {
   ...
   public ru.night.util.render.math.animation.Animation animation1 = new EaseInOutQuad(300, 1.0);
   public ru.night.util.render.math.animation.Animation animation2 = new EaseInOutQuad(300, 1.0);
   public final Animation2 mAnim = new Animation2();
   public ru.night.util.render.math.animation.Animation animation3 = new EaseInOutQuad(300, 1.0);
   public ru.night.util.render.math.animation.Animation animation4 = new EaseInOutQuad(300, 1.0);
